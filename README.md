...
// Подпишитесь до снимка, чтобы не потерять ротацию между этими действиями.
final updates = calls.pushTokenUpdates.listen((update) {
  // Сохраните новый токен на сервере или удалите старый при removed == true.
});
